    ...
    <>
      ...
      {user ? (
        <>
          ...
          >
            <a className="lg:text-black hover:text-[#9F99AA]">Logout</a>
          </li>
        </>
      ) : (
        <div className="flex lg:hidden flex-col gap-4 py-4">
          ...
          >
            <button
              className="
             bg-gradient-to-r from-[#3144D7] to-[#801C98] text-black border-none w-full
          ...
          <div className="navbar-end">
            {user ? (
              ...
              <div className="hidden lg:block">
                <button
                  className="
              btn bg-gradient-to-r from-[#3144D7] to-[#801C98] text-black border-none
